...
module Holidays
  ...
  module Bogarz # :nodoc:
    ...
    def self.holidays_by_month
      ...
      12 => [
              {:mday => 24, :observed => lambda { |date| Holidays.to_friday_if_weekend(date) }, :observed_id => "to_friday_if_weekend", :name => "Christmas Eve", :regions => [:bogarz]},
              ...
              {:mday => 31, :observed => lambda { |date| Holidays.to_friday_if_weekend(date) }, :observed_id => "to_friday_if_weekend", :name => "New Year's Eve", :regions => [:bogarz]}
            ]
      }
    end
  end
